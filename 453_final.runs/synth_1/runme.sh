...
HD_PWD='C:/Users/User/453Labs/453_final/453_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_6_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_6_top_level.tcl
