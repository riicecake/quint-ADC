...
HD_PWD='C:/Users/User/453Labs/453_final/453_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_6_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_6_top_level.tcl -notrace
